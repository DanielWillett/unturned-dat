...
internal sealed class Add : ExpressionFunction
{
    public static readonly Add Instance = new Add();
    static Add() { }

    public override string FunctionName => ExpressionFunctions.Add;
    ...
    {
        return MathMatrix.Add<TIn1, TIn2, TVisitor, TOut>(v1, v2, ref visitor);
    }
}