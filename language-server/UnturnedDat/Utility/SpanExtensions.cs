...
#pragma warning disable CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type
...
#else
        Span<char> ptr = stackalloc char[span.Length + span2.Length];
        span.CopyTo(ptr);
        span2.CopyTo(ptr[span.Length..]);
        return ptr.ToString();
#endif
    }
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_1_OR_GREATER
    ...
    public static unsafe string Concat(this ReadOnlySpan<char> span, ReadOnlySpan<char> span2, ReadOnlySpan<char> span3)
    {
        ...
        int len2 = len1 + span2.Length;
        Span<char> ptr = stackalloc char[len2 + span3.Length];
        span.CopyTo(ptr);
        span2.CopyTo(ptr[len1..]);
        span3.CopyTo(ptr[len2..]);
        return ptr.ToString();
#endif
    }
...
#else
        Span<char> ptr = stackalloc char[span.Length + str.Length];
        span.CopyTo(ptr);
        str.AsSpan().CopyTo(ptr[span.Length..]);
        return ptr.ToString();
#endif
    }
...
#pragma warning restore CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type
    ...
    /// </summary>
    /// <param name="span">Data to split.</param>
    /// <param name="ranges">Output split ranges. Use Count(<paramref name="separator"/>) + 1 for a buffer size.</param>
    /// <param name="separator">Character to split around.</param>
