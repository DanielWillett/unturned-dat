...
{
    public IType<int> DefaultType => Int32Type.Instance;
    ...
    public void WriteJson(Utf8JsonWriter writer, int value, ref TypeConverterFormatArgs args, JsonSerializerOptions options)
    {
