...
{
    public IType<ushort> DefaultType => UInt16Type.Instance;
    ...
    public void WriteJson(Utf8JsonWriter writer, ushort value, ref TypeConverterFormatArgs args, JsonSerializerOptions options)
    {
